...
async def test_can_not_follow_yourself(ac: AsyncClient):
...
async def test_can_not_follow_when_already_followed(ac: AsyncClient):
    """
...
async def test_can_not_follow_nonexistent_user(ac: AsyncClient):
    """
    Test POST /api/users/post_id/follow
...
async def test_can_not_unfollow_when_user_is_not_followed(ac: AsyncClient):
    """
...
async def test_can_not_get_user_data_of_nonexistent_user(ac: AsyncClient):
